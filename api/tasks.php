...
switch ($action) {
    ...
    case 'add':
        ...
        if (!$title) {
            ...
            if ($stmt->execute()) $response = ['success' => true, 'message' => 'Task added'];
            else $response['message'] = 'Error adding task';
        }
        break;
    ...
    case 'update':
        ...
        if ($stmt->execute()) $response = ['success' => true, 'message' => 'Task updated'];
        else $response['message'] = 'Error updating task';
        break;
    ...
    case 'delete':
        ...
        if ($stmt->execute()) $response = ['success' => true, 'message' => 'Task deleted'];
        else $response['message'] = 'Error deleting task';
        break;
